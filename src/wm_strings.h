...
const char HTTP_HEAD_END[]         PROGMEM = "</head><body class='{c}'><div style='line-height:80%;margin-bottom:0;padding-bottom:0;'>"
"<a href='/' style='text-decoration:none;'><h1>" APP_TITLE "</h1></a></div><div class='wrap'>"; // {c} = _bodyclass
...
const char HTTP_UPDATE[] PROGMEM = "Upload new firmware<br/><form method='POST' action='u' enctype='multipart/form-data' onchange=\"(function(el){document.getElementById('uploadbin').style.display = el.value=='' ? 'none' : 'initial';})(this)\"><input type='file' name='update' accept='.bin,.gz,application/octet-stream'><button id='uploadbin' type='submit' class='h D'>Update</button></form>";
...
const char HTTP_INFO_staip[]      PROGMEM = "<dt>Station IP</dt><dd>{1}</dd><dt>WebDAV Server</dt><dd><a href='http://{1}:" STR(DAV_SERVER_PORT) "' style='font-weight: normal;'>http://{1}:" STR(DAV_SERVER_PORT) "</a></dd>";
...
const char HTTP_INFO_aboutarduino[] PROGMEM = "<dt>Firmware link</dt><dd><a href='" APP_GITHUB "' style='font-weight: normal;'>" APP_GITHUB "</a></dd><dt>Firmware version</dt><dd>" APP_VERSION "</dd>";
